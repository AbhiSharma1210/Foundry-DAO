...
contract MyGovernorTest is Test {
    ...
    function testCant_update_Box_without_Governance() public {
        vm.expectRevert();
        box.store(1);
    }

    function testGovernance_Updates_Box() public {
        ...
        uint8 voteWay = 1; //Voting yes, its enum in GovernorCountingSimple.sol in openzeppelin
        vm.prank(USER);
        governor.castVoteWithReason(proposalId, voteWay, reason);

        // Now lets speedup the voting period since I am the only voter
